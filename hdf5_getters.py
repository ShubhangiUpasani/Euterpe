...
def get_song(h5, songidx=0):
    """
    Extension: Pranshu Gupta
    Get all the song attributes
    """
    song = {}
    song['analysis_sample_rate'] = get_analysis_sample_rate(h5, songidx)
    song['artist_7digitalid'] = get_artist_7digitalid(h5, songidx)
    song['artist_familiarity'] = get_artist_familiarity(h5, songidx)
    song['artist_hotttnesss'] = get_artist_hotttnesss(h5, songidx)
    song['artist_id'] = get_artist_id(h5, songidx)
    song['artist_latitude'] = get_artist_latitude(h5, songidx)
    song['artist_location'] = get_artist_location(h5, songidx)
    song['artist_longitude'] = get_artist_longitude(h5, songidx)
    song['artist_mbid'] = get_artist_mbid(h5, songidx)
    song['artist_name'] = get_artist_name(h5, songidx)
    song['artist_playmeid'] = get_artist_playmeid(h5, songidx)
    song['audio_md5'] = get_audio_md5(h5, songidx)
    song['danceability'] = get_danceability(h5, songidx)
    song['duration'] = get_duration(h5, songidx)
    song['end_of_fade_in'] = get_end_of_fade_in(h5, songidx)
    song['energy'] = get_energy(h5, songidx)
    song['key'] = get_key(h5, songidx)
    song['key_confidence'] = get_key_confidence(h5, songidx)
    song['loudness'] = get_loudness(h5, songidx)
    song['mode'] = get_mode(h5, songidx)
    song['mode_confidence'] = get_mode_confidence(h5, songidx)
    song['release'] = get_release(h5, songidx)
    song['release_7digitalid'] = get_release_7digitalid(h5, songidx)
    song['song_hotttnesss'] = get_song_hotttnesss(h5, songidx)
    song['song_id'] = get_song_id(h5, songidx)
    song['start_of_fade_out'] = get_start_of_fade_out(h5, songidx)
    song['tempo'] = get_tempo(h5, songidx)
    song['time_signature'] = get_time_signature(h5, songidx)
    song['time_signature_confidence'] = get_time_signature_confidence(h5, songidx)
    song['title'] = get_title(h5, songidx)
    song['track_7digitalid'] = get_track_7digitalid(h5, songidx)
    song['track_id'] = get_track_id(h5, songidx)
    song['year'] = get_year(h5, songidx)
    return song